...
<p>All three models have mutual relationships. Also, I am a part-time student, and have some time on my hand. I want to work on this as a solo project. Hope that's okay with you guys. I am using bootstrap gemfile with following code inserted to the gemfile: "gem 'bootstrap-sass', '~> 3.2.0'"</p>
